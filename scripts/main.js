require([ "lib/requirejs/domReady", "lib/canvas", "lib/drawable", "lib/drawables/graph/horizontalaxe", "lib/drawables/graph/verticalaxe", "lib/drawables/graph/graph", "lib/drawables/shapes/square", "lib/drawables/graph/axelabels", "lib/drawables/shapes/screencross"],
  function( domReady, Canvas, Drawable, HorizontalAxe, VerticalAxe, Graph, Square, AxeLabels, ScreenCross ) {
    domReady(function() {
      ...
      if(true) {
        ...
        myCanvas.addObject(new ScreenCross());
      ...
      myCanvas.draw();
      //myCanvas.viewRangeByUnits(-50, 3000, -50, 1500);
    });
  });
